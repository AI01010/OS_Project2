...
/*
The Output 
 the output send to console AND logfile.txt should be in the following format.
 The output should be sent to both the console and a logfile.txt file. The logfile.txt file should be created
